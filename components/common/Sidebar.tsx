...
export const Sidebar: React.FC<SidebarProps> = ({ setCurrentView, currentView }) => {
  return (
    <aside className="hidden md:flex flex-col w-64 bg-brand-gray border-r-2 border-brand-gold">
          ...
          <ul>
            ...
            />
             <NavItem
              ...
              onClick={() => setCurrentView('uploadParties')}
              icon={
